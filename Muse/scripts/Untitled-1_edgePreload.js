...
if(document.addEventListener ){ 
   ...
   aLoader = [
    { load: "scripts/edge_includes/jquery-1.7.1.min.js"},
    { load: "scripts/edge_includes/edge.2.0.1.min.js"},
          { load: "scripts/Untitled-1_edge.js"},
          { load: "scripts/Untitled-1_edgeActions.js"}];
